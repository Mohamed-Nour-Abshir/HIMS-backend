                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="list-icon-function">
                                                        ...
                                                        <a href="javascript:void(0)" onclick="confirm('Are you sure to delete this feedback?') || event.stopImmediatePropagation()"  wire:click.prevent="deleteCourse({{$course->id}})">
