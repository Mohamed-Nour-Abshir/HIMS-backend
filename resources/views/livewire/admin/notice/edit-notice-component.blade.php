<div>
    <div class="main-content-inner">
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                <!-- form-add-product -->
                <form class="tf-section-2 form-add-product" wire:submit.prevent='updateNotice'>

                <div class="wg-box">
                    <fieldset class="name">
                        <div class="mb-10 body-title">Title <span class="tf-color-1">*</span>
                        </div>
                        <input class="mb-10 @if('title') is-invalid @endif" type="text" placeholder="Title" wire:model='title'>
                    ...
                    <fieldset class="name">
                        ...
                        <textarea class="mb-10 @if('description') is-invalid @endif"  placeholder="Description" wire:model='description'></textarea>
                        ...
                        <div class="flex-grow upload-image">
                            <div id="upload-file" class="item up-load">
                                <label class="uploadfile" for="myFile">
                                    ...
                                    @else
                                        <img src="{{ asset('assets/images/notice/'.$old_image) }}" alt="" width="300">
                                    @endif
                                </label>
                            </div>
                        </div>
