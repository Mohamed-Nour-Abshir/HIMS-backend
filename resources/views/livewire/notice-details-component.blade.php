          ...
          <div class="row">
            <div class="col-md-12">
              <div class="block text-center">
                {{-- <span class="text-white">Notice details</span> --}}
                <h1 class="mb-5 text-lg text-capitalize">Notice details</h1>
              ...
              <div class="single-blog-item">
                  ...
                  <div class="mt-5 blog-item-content">
                      ...
                      <div class="mb-4" style="width: 100%;">
                          <img src="{{ asset('assets/images/notice/'.$notice->image) }}" alt="{{ $notice->slug }}" class="img-fluid">
                      </div>

                      <h2 class="mb-4 text-md"><a href="blog-single.html">{{ $notice->title }}</a></h2>
